...
import QLHoaDon.ChiTietHoaDon;
import QLHoaDon.TTChiTietHoaDon;
...
public class ChiTietHoaDonGui extends javax.swing.JFrame {
    ...
    public ChiTietHoaDonGui() {
        initComponents();
        chiTietHoaDon = new ChiTietHoaDon(); // Khởi tạo đối tượng ChiTietHoaDon
        tableModel = (DefaultTableModel) tblChiTietHoaDon.getModel(); // Lấy model từ JTable
        loadChiTietHoaDon(); // Gọi hàm để load chi tiết hóa đơn vào bảng
        
        // Thêm listener cho tblChiTietHoaDon
        tblChiTietHoaDon.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) { // Chỉ xử lý khi sự kiện không đang điều chỉnh
                    int selectedRow = tblChiTietHoaDon.getSelectedRow(); // Lấy chỉ số hàng được chọn
                    if (selectedRow != -1) { // Kiểm tra xem có hàng nào được chọn không
                        // Lấy thông tin chi tiết hóa đơn từ hàng được chọn
    ...
    // Hàm để load danh sách chi tiết hóa đơn vào bảng tblChiTietHoaDon
    private void loadChiTietHoaDon() {
        // Lấy danh sách chi tiết hóa đơn
        List<TTChiTietHoaDon> danhSachCTHD = chiTietHoaDon.getDanhSachChiTietHoaDon();

        // Xóa tất cả dữ liệu hiện có trong bảng
        tableModel.setRowCount(0);

        // Thêm dữ liệu chi tiết hóa đơn vào bảng
        for (TTChiTietHoaDon cthd : danhSachCTHD) {
            Object[] row = {
                cthd.getMaCTHD(),
                cthd.getSoLuong(),
                cthd.getGiaTien(),
    ...
    private void updateFieldsFromSelectedRow(int selectedRow) {
        // Lấy giá trị từ bảng
        String maCTHD = (String) tableModel.getValueAt(selectedRow, 0);
        int soLuong = (Integer) tableModel.getValueAt(selectedRow, 1);
        double giaTien = (Double) tableModel.getValueAt(selectedRow, 2);
    ...
    private void initComponents() {
        ...
        tblChiTietHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã chi tiết hóa đơn", "Số lượng", "Giá tiền"
            }
        ) {
        ...
        tblChiTietHoaDon.setSelectionBackground(new java.awt.Color(0, 153, 153));
        ...
        jLabel12.setText("Thông tin chi tiết hóa đơn");
        ...
        jLabel13.setText("Danh sách chi tiết hóa đơn");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 609, Short.MAX_VALUE)
                .addGap(15, 15, 15))
        );
        ...
        btnThemChiTietHoaDon.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnThemChiTietHoaDon.setText("Thêm");
        ...
        panelBoderFrm2Layout.setHorizontalGroup(
            ...
            .addGroup(panelBoderFrm2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnThemChiTietHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(panelBoderFrm2Layout.createSequentialGroup()
                ...
                .addGroup(panelBoderFrm2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBoderFrm2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnThemChiTietHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnTimKiem.setText("Tìm kiếm chi tiết");
        btnTimKiem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTimKiemActionPerformed(evt);
            }
                    ...
                    .addGroup(panelBoderFrm1Layout.createSequentialGroup()
                        .addGroup(panelBoderFrm1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(panelBoderFrm1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtGiaTien, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(panelBoderFrm1Layout.createSequentialGroup()
                            ...
                            .addGroup(panelBoderFrm1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(txtMaCTHD, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel11.setText("QUẢN LÝ CHI TIẾT HÓA ĐƠN");

        btnChiTietHoaDon.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnChiTietHoaDon.setText("Hóa đơn");
    ...
    private void btnThemChiTietHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemChiTietHoaDonActionPerformed
        ...
        TTChiTietHoaDon hd = new TTChiTietHoaDon(maCTHD, soLuong, giaTien);

        // Thêm sản phẩm vào cơ sở dữ liệu
        ChiTietHoaDon hoaDon = new ChiTietHoaDon();
        boolean success = hoaDon.themChiTietHoaDonMoi(hd);
        ...
        if (success) {
            ...
            model.addRow(new Object[]{maCTHD, soLuong, giaTien});

            // Sắp xếp bảng theo mã sản phẩm
            TableRowSorter<TableModel> sorter = new TableRowSorter<>(tblChiTietHoaDon.getModel());
            tblChiTietHoaDon.setRowSorter(sorter);
            ...
            if (rowCount > 0) {
                tblChiTietHoaDon.setRowSelectionInterval(rowCount - 1, rowCount - 1); // Chọn dòng cuối
                tblChiTietHoaDon.scrollRectToVisible(tblChiTietHoaDon.getCellRect(rowCount - 1, 0, true)); // Cuộn đến dòng cuối
            }
        } else {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        String maHD = tblChiTietHoaDon.getValueAt(selectedRow, 0).toString();  // Cột 0 là cột MaSP
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            ChiTietHoaDon hoaDon = new ChiTietHoaDon();
            boolean success = hoaDon.xoaChiTietHoaDon(maHD);
    ...
    private void btnCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCapNhatActionPerformed
        ...
        double tongTien = Double.parseDouble(txtGiaTien.getText());
        // Tạo đối tượng sản phẩm với thông tin mới
        TTChiTietHoaDon sp = new TTChiTietHoaDon(maCTHD, sl, tongTien);

        // Sửa sản phẩm trong cơ sở dữ liệu
        ChiTietHoaDon hoaDon = new ChiTietHoaDon();
        boolean success = hoaDon.suaChiTietHoaDon(sp);

        if (success) {
            // Cập nhật bảng hiển thị
            DefaultTableModel model = (DefaultTableModel) tblChiTietHoaDon.getModel();
            model.setValueAt(sp.getMaCTHD(), selectedRow, 0);  // Cập nhật MaSP tại dòng được chọn
            model.setValueAt(sp.getSoLuong(), selectedRow, 1); // Cập nhật TenSP tại dòng được chọn
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (!tuKhoa.isEmpty()) {
            ChiTietHoaDon hoaDon = new ChiTietHoaDon(); // Tạo đối tượng SanPham để truy cập hàm tìm kiếm
            List<TTChiTietHoaDon> danhSachTimKiem = hoaDon.timKiemChiTietHoaDon(tuKhoa);

            // Cập nhật dữ liệu vào bảng
            DefaultTableModel model = (DefaultTableModel) tblChiTietHoaDon.getModel();
            model.setRowCount(0); // Xóa dữ liệu cũ trên bảng

            for (TTChiTietHoaDon sp : danhSachTimKiem) {
